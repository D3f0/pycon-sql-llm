...
class State(BaseModel):
    database: str = Field(description="SQLAlchemy database string")
    question: str = ""
    schema: str = ""
...
graph_builder.add_node("get_schema", lambda s: s)
graph_builder.add_node("generate_sql_query", lambda s: s)
graph_builder.add_node("run_query", lambda s: s)
graph_builder.add_edge(START, "lambda_1")
graph_builder.add_edge("lambda_1", "lambda_2")
