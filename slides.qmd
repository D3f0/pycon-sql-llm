...
In this talk we're gonna show how to use Python to:
  ...
  - {{< bi bug-fill >}} More advanced nodes
...
::: {.fragment .fade-in-then-semi-out}
<img src="./img/langgraph.svg"/> When our code starts to become larger than a script can handle 🏋🏾‍♀️, `LangGraph` is a great
...
## Visualizing the graph {{< bi diagram-3 >}} {.smaller}
